...
# actual_df = pd.read_csv("../groundtruth/GT.csv", header=None)
# predicted_df = pd.read_csv("../prediction/output.csv", header=None)

actual_df = pd.read_csv("..\\GroundTruth\\GT.csv", header=None)
predicted_df = pd.read_csv("..\\Prediction\\PT.csv", header=None)
